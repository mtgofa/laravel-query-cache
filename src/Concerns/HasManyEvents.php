...
namespace MTGofa\QueryCache\Concerns;

use MTGofa\QueryCache\HasMany;
 ...
 *
 *
 * @mixin \MTGofa\QueryCache\Traits\HasDispatchableEvents
 */
trait HasManyEvents
{
    /**
    ...
    protected static function registerModelHasManyEvent($event, $callback)
    {
        if (isset(static::$dispatcher)) {
            $name = static::class;
            //dd(static::$dispatcher, $event, $name, $callback);
     ...
     * @param \Closure|string $callback
     */
    public static function hasManyDeleting($callback)
    {
        static::registerModelHasManyEvent('hasManyDeleting', $callback);
    }
     ...
     * @param \Closure|string $callback
     */
    public static function hasManyDeleted($callback)
    {
